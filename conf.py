...
BLOG_AUTHOR = "Lubosz \"diltram\" Kosnik"  # (translatable)
BLOG_TITLE = "Diltram's blog"  # (translatable)
SITE_URL = "http://diltram.net/"
BASE_URL = "http://diltram.net/"
BLOG_EMAIL = "diltram@gmail.com"
BLOG_DESCRIPTION = "Diltram's blog about technology, clouds" \
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://github.com/diltram', 'My Github', 'icon-github'),
        # TODO: Add about me page
        # (SITE_URL, 'About me', 'icon-user'),
    )
}
...
# Timezone used to publish posts
...
FILTERS = {
    ".jpg": ["jpegoptim -s -m75 -v '%s'"],
    ".png": ["optipng -strip all '%s'"],
}
...
# (translatable)
EXTRA_HEAD_DATA = """
<meta name="cf-2fa-verify" content="d2a4e0c7ba32c6e">
"""
